...
OutputBaseFilename=VidCoder-0.8.1-x64
...
Source: "..\HandBrakeInterop\HandBrakeInterop\bin\x64\Release\HandBrakeInterop.dll"; DestDir: "{app}"
Source: "..\HandBrakeInterop\HandBrakeInterop\bin\x64\Release\HandBrakeInterop.pdb"; DestDir: "{app}"
